...
class CollectSignaturesFlow @JvmOverloads constructor(val partiallySignedTx: SignedTransaction,
    ...
    override fun call(): SignedTransaction {
        ...
        // the FinalityFlow.expo
        val needsNotarisation = partiallySignedTx.tx.inputs.isNotEmpty() || partiallySignedTx.tx.references.isNotEmpty() || partiallySignedTx.tx.timeWindow != null
